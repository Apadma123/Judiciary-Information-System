...
public class User{
	...
	public void initPanel(JISS p){
		...
		mainPanel.add(lblNoOfViews);
                //charge which the lawer can charge
                JButton btnView2 = new JButton("charge");
		btnView2.setBounds(371, 79, 117, 20);
		mainPanel.add(btnView2);
               btnView2.setVisible(type=='L');
                btnView2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                            int   m=12;
                            JLabel k=lblNoOfViews;
                            
                            
                            JOptionPane.showMessageDialog(panel,lblNoOfViews);
                                    return;
                        }
                                    });
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                                String j=String.valueOf(pwdNew_1.getPassword());
                                System.out.print(j);
